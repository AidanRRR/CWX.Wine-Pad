                ...
                {({errors, touched}) => (
                    <div>
                        <div className="form-group row">
                            <label htmlFor="example-text-input" className="col-sm-3 col-form-label">Naam</label>
                        ...
                        <div className="form-group row">
                            <label htmlFor="example-text-input" className="col-sm-3 col-form-label">Omschrijving</label>
                            <div className="col-sm-9">
                                <Field type="text"
                                       component={"textarea"}
